...
import datetime
import pandas as pd
import random,string,os,time,json,pickle
...
def save_cookies(cookies_dir='cookies'):
    "保存用户cookies"
    ...
    cookie_list = [f for f in os.listdir(cookies_dir)]
    while True:
        cookie_name = '%s.cookie'%gen_random_string(10)
        if cookie_name not in cookie_list:
    ...
    while 1:
        ...
        if jud2 == '1':
            ...
            json.dump(browser.get_cookies(), open(cookie_path, 'w'))
            break
...
if __name__ == '__main__':
    ...
    # 收集cookies
    save_cookies(cookies_dir="/Users/wukefei/Downloads/wukefei/cookies")
